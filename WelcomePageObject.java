...
public class WelcomePageObject extends MainPageObject
{
    ...
    STEP_WAYS_TO_EXPLORE_TEXT = "id:New ways to explore",
    ...
    {
        this.waitForElementPresent(STEP_WAYS_TO_EXPLORE_TEXT, "Cannot find 'New ways to explore' link", 10);
    }
    ...
    public void waitForLearnMoreAboutDataCollectText()
    {
        this.waitForElementPresent(STEP_LEARN_MORE_DATA_COLLECTED_LINK, "Cannot find 'Learn more about data collected' link", 10);
    }
    ...
    public void clickNextGetStartedButton()
    {
